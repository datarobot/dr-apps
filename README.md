...
| `--stringEnvVar`   | Enter a string key value par like ENV*VAR_KEY="A string value" to pass down to the application. It can be referenced in the application code as `MLOPS_RUNTIME_PARAM*{ENV_VAR_KEY}`                                                                                                                                                                                                                                                                       |
| `--numericEnvVar`  | Enter a numeric (integer or float) key value par like ENV*VAR_KEY=42 or ENV_VAR_KEY=12.51 to pass down to the application. It can be referenced in the application code as `MLOPS_RUNTIME_PARAM*{ENV_VAR_KEY}`                                                                                                                                                                                                                                            |
